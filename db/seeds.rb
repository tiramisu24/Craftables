...
user2 = User.create(username: "calamari", password: "password", img_url: "http://res.cloudinary.com/dezhy95vj/image/upload/v1490216839/ci96tpehqzmry74hroil.jpg",
bio: "Calamari is a culinary name for squid, especially for dishes from the Mediterranean, notably fried squid (fried calamari).There are many ways of preparing and cooking squid, with every country and region having its own recipes.");
user3 = User.create(username: "flower", password: "password", img_url: "https://res.cloudinary.com/dezhy95vj/image/upload/t_media_lib_thumb/v1490120414/sample.jpg",
 bio: "A flower, sometimes known as a bloom or blossom, is the reproductive structure found in plants that are floral (plants of the division Magnoliophyta, also called angiosperms).");
